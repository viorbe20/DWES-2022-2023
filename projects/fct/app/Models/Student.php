...
class Student extends DBAbstractModel
{
    ...
    {
        try{   
            $this->query = "INSERT INTO students (s_dni, s_name, s_surname1, s_surname2, s_email, s_phone, s_created_at, s_updated_at) 
            VALUES (:s_dni, :s_name, :s_surname1, :s_surname2, :s_email, :s_phone, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)";
            $this->parametros['s_dni'] = $this->s_dni;
            ...
            echo "<script>alert('Se ha producido un error al insertar el estudiante. Por favor, inténtelo de nuevo más tarde.');</script>";
        }
    }
