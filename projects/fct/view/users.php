...
<head>
    ...
    <script src="<?php echo DIRBASE?>/assets/js/users.js"></script>
...
<body class='d-flex flex-column'>
    ...
    <h3 class='d-flex text-center mx-5 mb-4 text-secondary'>Gestión de usuarios</h3>
<?php
require_once '../view/require/search_box_user.php';
require_once '../view/require/table_users.php';
?>
    </main>
</body>
