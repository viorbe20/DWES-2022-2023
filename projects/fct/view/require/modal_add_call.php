    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" name='add_assignment' class=''>
            ...
            <div class="modal-footer">
                <button id="btn_modal_confirm_call" name="btn_modal_reload" type="button" class="btn btn-primary">Crear</button>
                <button id="btn_modal_cancel_call" name="btn_modal_close" type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
            </div>
        </div>
    </div>
</div>